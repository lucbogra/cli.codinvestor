...
const form = useForm({
  ...
  default : props.defaultMethod == 'TransferWise' ? true : false,
})
  ...
  <form @submit.prevent="submit" class="space-y-8 divide-y divide-gray-200 bg-white rounded px-8 py-6">
    <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
      ...
      <div class="space-y-6 pt-8 sm:space-y-5 sm:pt-10">
        <div>
          <h3 class="text-lg font-medium leading-6 text-gray-900">TransferWise</h3>
        ...
        <div class="">
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4  sm:py-5 px-1">
            ...
            <div class="mt-1 sm:col-span-2 sm:mt-0">
              <input id="account_number" name="account_number" type="text" v-model="form.account_number" placeholder="Account Number" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" />
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4  sm:py-5 px-1">
            ...
            <div class="mt-1 sm:col-span-2 sm:mt-0">
              <input id="swift_code" name="swift_code" type="text" v-model="form.swift_code" placeholder="Swift code" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" />
