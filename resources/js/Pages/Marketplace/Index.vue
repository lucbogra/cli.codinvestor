                                    ...
                                    <ul class="fb">
                                        <li>
                                            ...
                                            <button class="flex items-center fc mr-2">
                                                ...
                                                <div class="inline-flex text-sm text-slate-500 gm"><span class="d">4
                                                        Stars</span> And up</div>
                                            </button>
                                        </li>
                                        <li>
                                            <!-- Rating button -->
                                            <button class="flex items-center fc mr-2">
                                                ...
                                                <div class="inline-flex text-sm text-slate-500 gm"><span class="d">3
                                                        Stars</span> And up</div>
                                            </button>
                                        </li>
                                        <li>
                                            ...
                                            <button class="flex items-center fc mr-2">
                                                ...
                                                <div class="inline-flex text-sm text-slate-500 gm"><span class="d">2
                                                        Stars</span> And up</div>
                                            </button>
                                        </li>
                                        <li>
                                            ...
                                            <button class="flex items-center fc mr-2">
                                                ...
                                                <div class="inline-flex text-sm text-slate-500 gm"><span class="d">1
                                                        Stars</span> And up</div>
                                            </button>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="flex ak sh">
                                        ...
                                        <div class="y">
                                            ...
                                            <div class="g te q ri mr-4">
                                                <div
                                                    class="inline-flex items-center go gp yp bg-slate-900 pf rounded-full gn vi vd">
