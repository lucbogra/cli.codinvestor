      ...
      <div class="bg-slate-100 m-10">
        ...
        <div class="flex ak fq ja jv jm zh zx zk tnq trr tri iv">
          ...
          <div>
            ...
            <div class="text-sm text-slate-500 gm ri" v-if="products?.data">{{ products.data.length }} {{
            ...
            <div class="">
              <div class="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                  <Link v-for="product in products.data" :key="product.id" :href="route('marketplace.detail', product.slug)" class="group">
                    <div class="aspect-w-1 aspect-h-1 w-full h-72 overflow-hidden rounded-lg bg-gray-200 xl:aspect-w-7 xl:aspect-h-8">
                      <img :src="product.photo" :alt="product.name" class="h-full w-full object-cover object-center group-hover:opacity-75" />
                    </div>
