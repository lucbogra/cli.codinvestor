...
import { CollectionIcon, ChevronLeftIcon, ArrowRightIcon } from '@heroicons/vue/solid';
    ...
    <template #content>
      ...
      <div class="md:px-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
        <div v-for="Integration in Integration_user"
          ...
          <h3 class="mb-3 text-3xl text-center font-bold text-primary-700">{{ Integration.name }}</h3>
          ...
          <div class="grid grid-cols-2 my-4">
            <a :href="Integration.external_link" target="_blank"
              class="btn-primary inline-flex mr-2 ">Read
              More<ArrowRightIcon class="text-white w-5 ml-2"/></a>
            <Link :href="route('oneclickvid.index')"
              class="ml-2 btn-primary">Start Your Service</Link>
          </div>
        </div>
