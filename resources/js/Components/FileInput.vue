<template>
  <div>
    ...
    <div class="form-input p-0 border-gray-400 rounded">
      <input ref="file" type="file" :accept="accept" class="hidden" :class="{ error: error } + 'border-gray-200 rounded'" @change="change" @input="$emit('update:modelValue', $event.target.files[0])" />
