...
<head>
    ...
    <title>Copie de Nouveau message 3</title>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://vkdrsr.stripocdn.email/content/guids/CABINET_d53e9a07f4c1898fd38ba2aa87adc022/images/logocod.png"
                                                                        alt="Logo"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        Invoice {{ $invoice->slug }} of {{ $invoice->invoice_date }}</h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                                                                              ...
                                                                                              <table
                                                                                                  ...
                                                                                                  <tr>
                                                                                                      ...
                                                                                                      <td style="padding:5px 0;Margin:0"
                                                                                                          ...
                                                                                                          <p
                                                                                                              style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                                             {{ collect($invoice->fundings)->sum('pivot.amount_paid') }}
                                                                                                          </p>
                                                                                                      </td>
                                                                                                  </tr>
                                                                                              </table>
                                                                                              ...
                                                                                              <table
                                                                                                  ...
                                                                                                  <tr>
                                                                                                      ...
                                                                                                      <td width="20%"
                                                                                                          ...
                                                                                                          <h4
                                                                                                              style="Margin:0;line-height:17px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px">
                                                                                                              -{{ collect($invoice->fundings)->sum('pivot.amount_paid') }} USD
                                                                                                          </h4>
                                                                                                      </td>
                                                                                                  </tr>
                                                                                              </table>
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="Margin:0;padding-bottom:10px;padding-top:20px;padding-right:20px;padding-left:40px">
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Customer:
                                                                        <strong>{{ $invoice->invoiceable->company }}</strong><br>Phone:
                                                                        {{ $invoice->invoiceable->phone }}<br>Adresse: {{ $invoice->invoiceable->country }} {{ $invoice->invoiceable->city }} {{ $invoice->invoiceable->address }} </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Payment method:&nbsp;<strong>{{ $invoice->payment_method }}</strong></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Currency: <b>USD</b></p>
                                                                </td>
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Got a question?&nbsp;Email us at&nbsp;<a
                                                                            ...
                                                                            target="_blank" href=""
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">codinvestor</a><a
                                                                            target="_blank" href=""
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">.com</a>.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        cod investor © {{date('Y')}}&nbsp;. All Rights
                                                                        Reserved.<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
